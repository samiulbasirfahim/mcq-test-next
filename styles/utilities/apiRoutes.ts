...
const creataeCategory = baseApi + "/category/create"
...
export default { getUser, getCategory, getQuestion, createQuestion, createUser, loginUser, deleteQuestion, editQuestion, submitResult, creataeCategory }
